...
; The filtered SFPU allocator requires LiveIntervals even at O0. Its shared
; dead-def analysis lets FastRA reload the scalar GVL before the RVV values.
; Keep the exact scalar/vector spill, CSR and return checks for that ordering.
